...
## 작업 원칙
- 먼저 반드시 읽는다: `src/boundary.ts`(envelope·에러 매핑의 실제 코드), `docs/architecture/error-handling.md`, `docs/architecture/data-access.md`, `src/core/AGENTS.md`, `src/app/api/AGENTS.md`. 여기 없는 새 envelope 패턴을 발명하지 않는다.
