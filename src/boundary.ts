...
const toErrorPayload = (e: unknown, logPrefix: string): ErrorPayload => {
...
const routeError = (e: unknown): NextResponse<ErrorResponse> => {
...
const actionError = (e: unknown): ActionErrorResult => {
