...
- API/도메인 계약 타입과의 경계: `src/shared/types/AGENTS.md`
- 이 모델을 조회/조작하는 비즈니스 로직: `src/server/services/AGENTS.md`
