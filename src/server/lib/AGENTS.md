# AGENTS.md — src/server/lib/

> Last updated: 2026-07-23
> 서버 전용 외부 연동만 다룬다 — 브라우저 전용 연동(`kakao`)과 조합 유틸(`cn`)은 `src/client/lib/AGENTS.md` 참고. 두 폴더는 물리적으로 분리됐을 뿐 폴더명/명명 컨벤션은 동일하다.
...
- 순수 함수와의 경계: `src/shared/utils/AGENTS.md`
- 클라이언트 전용 연동(kakao)/조합 유틸(cn): `src/client/lib/AGENTS.md`
