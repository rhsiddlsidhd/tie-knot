...
vi.mock(
  "@/app/(main)/(my-order)/my-orders/[orderId]/mobile-invitation/_containers/MobileInvitationStatusControls",
  () => ({
...
vi.mock(
  "@/app/(main)/(my-order)/my-orders/[orderId]/mobile-invitation/_containers/MobileInvitationForm",
  () => ({
